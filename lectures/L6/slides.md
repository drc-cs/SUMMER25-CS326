...
4. Triangle inequality: $d(x, y) + d(y, z) \geq d(x, z)$
    ...
    - If the distance between Bob and Alice is 5 years and the distance between Alice and Charlie is 5 years, then the distance between Bob and Charlie should be at least 10 years. We don't want shortcuts in our triangles!
